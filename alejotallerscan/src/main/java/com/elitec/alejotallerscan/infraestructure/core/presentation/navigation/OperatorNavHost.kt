...
import com.elitec.alejotallerscan.feature.history.presentation.screen.OperatorSaleRecordsScreen
...
fun OperatorNavHost(
    ...
    when (currentDestination) {
        ...
        OperatorDestination.Home -> OperatorHomeScreen(
            ...
            onOpenRecords = { onNavigate(OperatorDestination.Records) },
        ...
        OperatorDestination.Scan -> OperatorScanScreen(
            ...
            onOpenManualSearch = { onNavigate(OperatorDestination.Reservations) }
        )

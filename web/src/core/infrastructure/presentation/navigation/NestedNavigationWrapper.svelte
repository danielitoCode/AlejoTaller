...
.logout-native{width:100%;min-height:48px;display:inline-flex;align-items:center;justify-content:center;gap:10px;padding:14px 18px;border-radius:14px;border:1px solid color-mix(in srgb,#c62828 28%,transparent);background:color-mix(in srgb,#ef5350 18%,transparent);color:#e57373;font:inherit;font-size:.92rem;font-weight:700;cursor:pointer;transition:background .15s ease,border-color .15s ease}
.logout-native:hover{background:color-mix(in srgb,#ef5350 28%,transparent);border-color:color-mix(in srgb,#c62828 40%,transparent);color:#ef9a9a}

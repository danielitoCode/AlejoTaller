...
<style>
    ...
    .mgmt-muted { color: var(--md-sys-color-on-surface-variant); opacity: .85; }
    .mgmt-btn { display: inline-flex; align-items: center; gap: 6px; min-height: 34px; padding: 0 12px; border-radius: 10px; border: 1px solid var(--md-sys-color-outline-variant); background: var(--md-sys-color-surface-container-high); color: var(--md-sys-color-on-surface); font: inherit; font-size: .72rem; font-weight: 700; cursor: pointer; }
    .mgmt-btn:disabled { opacity: .55; cursor: not-allowed; }
    .mgmt-btn.primary { background: var(--md-sys-color-primary); color: var(--md-sys-color-on-primary); border-color: transparent; }
    .mgmt-btn.ghost { background: transparent; }
    .mgmt-btn.ghost:hover { background: color-mix(in srgb, var(--md-sys-color-on-surface) 6%, transparent); }
    .mgmt-btn.primary:hover:not(:disabled) { filter: brightness(1.06); }
</style>
